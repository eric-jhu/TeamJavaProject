...
public class shop {
	...
	private void showNotEnoughCoinsDialog() {
		JOptionPane.showMessageDialog(frmShop, "金幣不足，無法購買此物品！", "金幣不足", JOptionPane.WARNING_MESSAGE);
	}
	...
	private void setshop() {
		...
		JButton m1buyButton = new JButton("<html>幽冥法杖<br>$100 buy</html>");// 1號法師商品購買紐
		...
		JButton s1buyButton = new JButton("<html>屠戮之斧<br>$100 buy</html>");// 1號劍士商品購買紐
